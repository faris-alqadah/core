...
/*!
    ...
    \sa a the NRcluster to compute alpha-sigma for
    \sa params params[0] should contain the alpha value, params[1] contains the standard deviation of the row / column of interest
 */
...
/*!
    ...
    \sa a the NRcluster to compute the maximum spacing uniform estimator for
    \sa params params[0] should contain the alpha value, params[1] the cardinality of M (see paper), params[2] range of the subspace (see paper)
 */
